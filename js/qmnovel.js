/*
本脚本搬运自 @chavyleung  ，未做任何修改，只是添加了注释
...
使用方法：
1、关闭QX或Surge中的广告屏蔽, 否则无法获取小视频奖励cookie和url
2、打开 APP七猫小说 然后到APP内福利界面手动日常签到(观看小视频领取奖励),新手领福利签到,视频签到以及幸运大转盘 1 次, 系统提示: 首次写入xxxUrl成功🎉,首次写入xxxCookie成功🎉
然后就可以把第 1 条脚本注释掉了
运行一次脚本, 如果提示重复签到, 那就算成功了!
用浏览器访问一次获取 cookie 成功后就可以注释获取cookie 的重写规则了
